...
import { SectionHeading } from "../shared/EventShared";
...
const MOCK_FAQS = [
  ...
  { _id: "f3", question: "Is re-entry allowed?",
    answer: "Re-entry is not permitted once you exit the venue. Please plan accordingly and ensure you have everything you need before leaving." },
  { _id: "f4", question: "Are tickets refundable?",
    answer: "All ticket sales are final. However, tickets may be transferred to another person via the Ticket Bro app up to 2 hours before the event." },
  ...
  { _id: "f6", question: "Is there parking available?",
    answer: "Limited parking is available at the venue. We strongly recommend using public transport or ride-sharing services to avoid delays." },
];
            ...
            <div key={faq._id || i}
              ...
              <button
                ...
                <p className="text-sm font-semibold text-foreground"
                  style={{ fontFamily: "var(--font-sans)" }}>{faq.question}</p>
              ...
              {isOpen && (
                <div className="px-4 pb-4 border-t border-border">
                  <p className="text-sm text-muted-foreground leading-relaxed pt-3"
                    style={{ fontFamily: "var(--font-sans)" }}>{faq.answer}</p>
                </div>
              )}
            </div>
          );
