...
import { InputField, Button, Divider, UnverifiedBanner } from '@/components/shared';
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3">
        ...
        <label className="flex items-center gap-2 cursor-pointer w-fit group">
          <div className="relative flex-shrink-0">
            ...
            <svg className="absolute inset-0 m-auto w-2 h-2 text-black opacity-0 peer-checked:opacity-100 transition-opacity pointer-events-none" viewBox="0 0 10 8" fill="none">
