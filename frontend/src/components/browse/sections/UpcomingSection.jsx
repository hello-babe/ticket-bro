...
const UpcomingSection = () => {
  ...
  const title = level === "root" ? "Upcoming This Week" : `Upcoming ${config.label}`;
  return (
    <SectionShell title={title} subtitle={`Happening soon in ${locationLabel}`} icon={Clock} viewAllHref="/browse">
