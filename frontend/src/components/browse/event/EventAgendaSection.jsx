...
import { SectionHeading, fmtTime } from "./shared/EventShared.jsx";
          ...
          {items.map((item, i) => {
            ...
            return (
              <div key={item._id || i} className="flex gap-4 group">
                ...
                >
                  <div
                    className="w-3 h-3 rounded-full border-2 transition-colors relative z-10"
                    style={{
                      borderColor:
                        i === 0 ? "var(--foreground)" : "var(--border)",
                      background:
                        i === 0 ? "var(--foreground)" : "var(--background)",
                    }}
                  />
                </div>
                ...
                <div className="flex-1 pb-4">
                  ...
                  >
                    ...
                    {hasDetail && (
                      <ChevronDown
                        size={13}
                        className={`text-muted-foreground shrink-0 transition-transform mt-0.5 ${isOpen ? "rotate-180" : ""}`}
                      />
                    )}
                  </button>
                </div>
